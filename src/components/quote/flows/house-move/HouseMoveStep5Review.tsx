...
export function HouseMoveStep5Review({ data, onChange, onNext, onBack }: StepProps) {
  return (
            ...
            <div className="bg-white rounded-2xl shadow-sm border border-slate-200 p-6 lg:p-8">
              ...
              <div className="flex items-center gap-3 mb-6">
                ...
                <div>
                  ...
                  <p className="text-sm text-slate-600">Check all details and submit your quote request</p>
                </div>
              </div>

              <div className="space-y-6">
                <p className="text-slate-600">Review your details and submit...</p>
                ...
                <div className="flex justify-between pt-6 border-t border-slate-200">
                  ...
                  <button onClick={onNext} className="flex items-center gap-2 px-8 py-4 rounded-xl font-bold text-lg bg-gradient-to-r from-green-600 to-emerald-600 text-white hover:from-green-700 hover:to-emerald-700 shadow-lg hover:shadow-xl transition-all">
