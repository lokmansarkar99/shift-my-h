/**
 * Furniture & Items - Step 1: Address
...
import { ArrowRight, CheckCircle, Armchair } from 'lucide-react';
...
export function FurnitureStep1Address({ data, onChange, onNext }: StepProps) {
    ...
    if (!data.quoteReference) {
      ...
      fetch(`https://${projectId}.supabase.co/functions/v1/make-server-94f26792/save-quote-ref`, {
        ...
        body: JSON.stringify({
          ...
          serviceCategory: 'furniture_items',
        }),
  ...
  // FURNITURE: Only addresses + floors required (NO property types)
  const isFormValid = 
    pickupAddress && 
    deliveryAddress && 
    pickupFloor &&
      ...
      <div className="grid grid-cols-1 lg:grid-cols-[60%_40%] gap-6 lg:gap-8">
          ...
          <div className="bg-white rounded-2xl shadow-sm border border-slate-200 p-6 lg:p-8">
            ...
            <form onSubmit={handleNext} className="space-y-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div>
                  ...
                  <select
                    ...
                    required
                    className="w-full px-4 py-3 rounded-xl border border-slate-300 focus:border-purple-500 focus:ring-2 focus:ring-purple-200 outline-none bg-white"
                  >
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div>
                  <label className="flex items-center gap-3 cursor-pointer p-4 rounded-xl border border-slate-300 hover:border-purple-400 hover:bg-purple-50 transition-all">
                    <input
                      type="checkbox"
        ...
        <div className="space-y-6 lg:sticky lg:top-4 lg:self-start order-first lg:order-last">
          ...
          <MoveSummaryCard
            ...
            pickupPropertyType="" // No property type for furniture
            deliveryPropertyType="" // No property type for furniture
