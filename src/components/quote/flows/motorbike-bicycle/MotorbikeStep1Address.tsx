/**
 * Motorbike & Bicycle - Step 1: Address
...
import { ArrowRight, CheckCircle, Bike } from 'lucide-react';
...
export function MotorbikeStep1Address({ data, onChange, onNext }: StepProps) {
    ...
    if (!data.quoteReference) {
      ...
      fetch(`https://${projectId}.supabase.co/functions/v1/make-server-94f26792/save-quote-ref`, {
        ...
        body: JSON.stringify({
          ...
          serviceCategory: 'motorbike_bicycle',
        }),
