...
export default function Reviews() {
  ...
  const reviews = [
    ...
    },
    {
      ...
      service: 'Man & Van',
      avatar: '👨‍🔧',
      review: 'Needed a quick man and van service for a few items. The driver was punctual, helpful, and very reasonably priced. Will definitely use them again for future moves. Brilliant service from start to finish!',
      helpful: 25,
      verified: true
    },
    {
