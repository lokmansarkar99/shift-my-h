...
import { Star, Quote, ThumbsUp, Filter, Search, ArrowLeft, TrendingUp } from 'lucide-react';
...
export default function ReviewsPage({ 
  ...
  const reviews = [
    ...
    },
    {
      ...
      avatar: '👨‍🔧',
      review: 'Needed clearance service for a few items. The team was punctual, helpful, and very reasonably priced. Will definitely use them again for future moves. Brilliant service from start to finish!',
      helpful: 25,
      verified: true
    },
    {
  ...
  const stats = [
    { label: 'Total Reviews', value: '2,847', gradient: 'from-blue-500 to-cyan-500', icon: '📊' },
    { label: 'Average Rating', value: '4.9', gradient: 'from-purple-500 to-pink-500', icon: '⭐' },
    { label: 'Verified Customers', value: '98%', gradient: 'from-green-500 to-emerald-500', icon: '✓' },
    { label: 'Recommend Us', value: '96%', gradient: 'from-amber-500 to-orange-500', icon: '👍' }
  ];
        ...
        <div className="max-w-7xl mx-auto px-4 relative z-10">
          ...
          <div className="text-center mb-8">
            <div className="inline-flex items-center gap-2 bg-white/10 backdrop-blur-md border border-white/20 px-6 py-3 rounded-full mb-6">
              ...
              <span className="text-white text-sm tracking-wider uppercase">Customer Reviews</span>
            </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6 mb-12">
            {stats.map((stat, index) => (
              ...
              >
                ...
                <div className={`text-3xl md:text-4xl font-bold bg-gradient-to-r ${stat.gradient} bg-clip-text text-transparent mb-2 text-center`}>
                  {stat.value}
                </div>
          ...
          <div className="mb-6">
            <p className="text-slate-600 text-lg">
              Showing <span className="font-bold text-blue-600">{filteredReviews.length}</span> reviews
